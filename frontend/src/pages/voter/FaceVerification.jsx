...
function FaceVerification() {
  ...
  const handleVerification = () => {
    ...
    window.setTimeout(() => {
      ...
      setMessage('Face verified successfully. Redirecting to dashboard...')
    }, 2000)
  }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-6 py-16">
      <div className="w-full max-w-3xl rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
        <h1 className="text-3xl font-bold text-slate-900">Face Authentication</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          The system will match your live face with the stored voter record
          before granting access to the voting dashboard.
        </p>
